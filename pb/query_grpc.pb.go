...
type CategoryQueryClient interface {
	...
	// 指定されたIDのカテゴリを取得して返す
	ById(ctx context.Context, in *CategoryParam, opts ...grpc.CallOption) (*CategoryParam, error)
}
...
func (c *categoryQueryClient) ById(ctx context.Context, in *CategoryParam, opts ...grpc.CallOption) (*CategoryParam, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryParam)
...
type CategoryQueryServer interface {
	...
	// 指定されたIDのカテゴリを取得して返す
	ById(context.Context, *CategoryParam) (*CategoryParam, error)
...
func (UnimplementedCategoryQueryServer) ById(context.Context, *CategoryParam) (*CategoryParam, error) {
